...
const rounds = [
  { title: 'Знакомимся с Чхусоком', cheer: 'Не волнуйтесь: здесь нет выбывания. Любой ответ — это новая находка!' },
  { title: 'Еда и игры', cheer: 'Отличная команда! Смотрите на картинки и помогайте друг другу.' },
  { title: 'Я — исследователь Чхусока', cheer: 'Последний раунд! Вспомним всё, что уже увидели вместе.' }
];
...
const roundKorean = ['추석과 친해지기', '음식과 놀이 탐험', '나도 추석 탐험가'];
const extraRussian = [
